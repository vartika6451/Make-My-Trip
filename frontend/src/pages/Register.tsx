    ...
    <div className="min-h-[80svh] flex items-center justify-center px-4 py-12">
      <div className="glass max-w-md w-full rounded-3xl p-8 shadow-2xl border border-white/20">
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-bold mt-3 text-slate-800 dark:text-slate-100">Create Account</h2>
          <p className="text-xs text-slate-500 mt-1 font-semibold">Join us to book tickets and get rewards</p>
        </div>
        ...
        <p className="text-xs text-center text-slate-500 font-semibold mt-6">
          ...
          <Link to="/login" className="text-brand-primary hover:underline font-bold">Login here</Link>
        </p>
      </div>
    </div>
  );
